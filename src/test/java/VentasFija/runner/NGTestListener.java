...
import VentasFija.helpers.ExtentReportUtil;
...
import static VentasFija.helpers.BasePage.features;
...
public class NGTestListener implements ITestListener {
    ...
    public void onStart(ITestContext iTestContext) {
        ...
        features = extentReportUtil.extent.createTest(Feature.class, "Visor");
